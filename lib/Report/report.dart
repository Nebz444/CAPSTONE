  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        height: double.infinity, // Ensure the gradient covers the entire screen
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
            colors: [
              Color(0xFF0D2D56), // Darker blue (top)
              Color(0xFF1E5A8A), // Lighter blue (bottom)
            ],
          ),
        ),
        child: _isLoading
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0D2D56), // Dark blue matching the gradient
        centerTitle: true,
